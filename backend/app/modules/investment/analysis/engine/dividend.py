...
METRIC_CATALOG: tuple[MetricDefinition, ...] = (
    ...
    MetricDefinition(
        "Q1", "Conversión CFO/beneficio", "dividendo", _HIGHER, low_alarm=Decimal("0.8"), low_ok=ONE
    ),
    MetricDefinition(
        "Q2",
    ...
    MetricDefinition(
        "B3", "Años de dividendo en caja", "dividendo", _HIGHER, low_alarm=ONE, low_ok=Decimal(2)
    ),
    # Trayectoria (T)
    MetricDefinition(
        "T2",
