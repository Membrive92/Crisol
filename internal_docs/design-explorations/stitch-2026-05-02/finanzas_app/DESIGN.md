---
version: alpha
name: Finanzas App Design System
description: |
  Personal-finance suite with a modular, multi-portfolio shell. Tone is calm and analytical: dark by default, neutral surfaces, blue brand accent, semantic tonal chips for status. Privacy-first, local-first.
colors:
  primary: '#2f6fb8'
  primary-dark: '#245690'
  on-primary: '#f4f7fb'
  ...
  surface-tint: '#a5c8ff'
  primary-container: '#2f6fb8'
  on-primary-container: '#ebf1ff'
  inverse-primary: '#175fa7'
  secondary: '#c3c6d2'
  on-secondary: '#2c303a'
  ...
  tertiary: '#ffb872'
  on-tertiary: '#4a2800'
  tertiary-container: '#a15d00'
  on-tertiary-container: '#ffeee1'
  error: '#ffb4ab'
  on-error: '#690005'
